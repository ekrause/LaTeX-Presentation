...
\lstset{    %language=[LaTeX]TeX, 
            ...
            breaklines=true, 
            morekeywords={\title, \documentclass, \author, \date, \begin, \end, \textbf, \textit, \emph, \underline, \texttt, \section, \item, \noindent, \sum, \limits, \infity, \omega, \dfrac, \cdot, \pi, \sqrt, &, \hline, \ref, \usepackage, \includegraphics, \centering, \caption, \bf, \it, \color, \tiny,\footnotesize, maketitle, subsubsection, subsection, thesection, lstinputlisting, @ARTICLE, AUTHOR, TITLE, JOURNAL, ISSUE, PAGES, VOLUME, YEAR}
        }
